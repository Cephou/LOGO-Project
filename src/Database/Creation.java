...
public class Creation {
	...
	public Creation(){
		...
		database.createTable("drop table if exists COMPLETE;create table COMPLETE("
		...
		database.createTable("drop table if exists EXERCISE;create table EXERCISE("
		...
		database.createTable("drop table if exists IS_AVAILABLE;create table IS_AVAILABLE("
		...
		database.createTable("drop table if exists RULE;create table RULE("
		...
		database.createTable("drop table if exists SCHOOLCLASS;create table SCHOOLCLASS("
				+ "NAME_CLASS           varchar(50) not null,"
				+ "primary key (NAME_CLASS));");
		
		// Creation of table TEACHER
		database.createTable("drop table if exists TEACHER;create table TEACHER("
